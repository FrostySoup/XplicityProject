...
export interface IReadOnlyService<TOut> {
    ...
    getItemByIdNum(id: number): Observable<TOut>;
}
...
export class ReadOnlyServiceBase<TOut>
    ...
    public getItemByIdNum(id: number): Observable<TOut> {
        return this.getItemByIdInternalNum(id, '');
    }

    protected getItemByIdInternalNum(id: number, hostUrl: string): Observable<TOut> {
